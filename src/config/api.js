...
exports.getBulletinSparks = (data, callback) => {
	fetchDataAndProceed('/locations/bulletin', method_types.post, data, callback);
};

exports.getMapSparks = (data, callback) => {
	fetchDataAndProceed('/locations/mapView', method_types.get, data, callback);
};

exports.getContactUs = (data, callback) => {
	fetchDataAndProceed('/stores/userqueries', method_types.post, data, callback);
};